                ...
                Box(
                    ...
                    val doc = when (characterIndex.value) {
                        ...
                        2 -> when (characterList[characterIndex.value].level) {
                            ...
                            1 -> "\n\n모모는 종을 알 수 없는\n\n귀염둥이 강아지입니다.\n\n넘치는 충성심으로 항상\n\n모험가님의 곁을 따르며,\n\n모험가님에게 일어날 수 있는\n\n안 좋은 일들을 막아주는\n\n행운의 아이입니다!"
                            2 -> "\n\n모모는 요즘 꼬리가 점점 길어지고\n\n등이 자꾸 간지럽다고 하네요!\n\n등을 긁어주다 만져지는\n\n이건 뭐지..? 날개....?"
                            3 -> "\n\n앗! 오리무중이었던 모모의 종을\n\n드디어 알겠군요! 모모는\n\n\"용강아지\"였습니다!\n\n모모는 거대한 날개로 세상을 탐험하며\n\n모험가님에게 항상 든든한\n\n파트너가 되어줄거에요!"
                            else -> ""
                        }

                        else -> ""
                    }
                    Text(text = doc, fontSize = 24.sp, fontFamily = fontFamily, color = textColor, textAlign = TextAlign.Center)
                }
            }
        }
    }
